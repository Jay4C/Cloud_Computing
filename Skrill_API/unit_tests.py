...
class UnitTestsSkrillAPITokenManagement(unittest.TestCase):
    ...
    def test_get_auth_realms_dw_v1_authorize(self):
        ...
        querystring = {"code_challenge_method": "code_challenge_method", "code_challenge": "code_challenge",
                       "state": "state", "scope": "scope", "redirect_uri": "redirect_uri", "client_id": "client_id",
...
class UnitTestsSkrillAPIClientManagement(unittest.TestCase):
    ...
    def test_post_v1_registrations(self):
        ...
        data = '{"redirect_uris":["string"],"token_endpoint_auth_method":"urn:paysafe:oauth:token-endpoint-auth-method:eidas-qwac:psd","grant_types":["string"],"response_types":["string"],"client_name":"string","logo_uri":"string","scope":"string","jwks":{"keys":[{"kty":"RSA","use":"sig","key_ops":["string"],"kid":"string","x5c":["string"],"x5u":"string"}]}}'
...
class UnitTestsSkrillAPIAccountInformationService(unittest.TestCase):
    ...
    def test_get_v1_transactions_all_transactions_history(self):
        ...
        querystring = {"countPerPage": "countPerPage", "page": "page", "toDate": "toDate", "fromDate": "fromDate",
                       "accountId": "accountId"}
...
class UnitTestsSkrillAPIPaymentInitiationService(unittest.TestCase):
    ...
    def test_get_me_send_money_preview(self):
        ...
        querystring = {"recipientEmail": "recipientEmail", "senderAccountId": "senderAccountId", "currency": "currency",
                       "amount": "amount"}
    ...
    def test_post_me_send_money(self):
        ...
        data = '{"amount":123,"currency":"string","message":"string","recipientEmail":"string","senderAccountId":"string"}'

        response = requests.post('https://mobile-api.skrill.com/mobile/me/send-money', headers=headers, data=data)
    ...
    def test_post_me_send_money_slipid_finalize(self):
        ...
        response = requests.post('https://mobile-api.skrill.com/mobile/me/send-money/slipID/finalize', headers=headers,
                                 data=data)
