...
class UnitTestsOrdersAPI(unittest.TestCase):
    ...
    def test_get_order(self):
        ...
        response = requests.get('https://api.mollie.com/v2/orders/ord_kEn1PlbGa', headers=headers, params=params)
    ...
    def test_update_order(self):
        ...
        data = '{ "billingAddress": { "organizationName": "Mollie B.V.", "streetAndNumber": "Keizersgracht 126", "city": "Amsterdam", "region": "Noord-Holland", "postalCode": "1234AB", "country": "NL", "title": "Dhr", "givenName": "Piet", "familyName": "Mondriaan", "email": "piet@mondriaan.com", "phone": "+31208202070" } }'
    ...
    def test_cancel_order_lines(self):
        ...
        response = requests.delete('https://api.mollie.com/v2/orders/ord_8wmqcHMN4U/lines', headers=headers, data=data)
    ...
    def test_create_order_payment(self):
        ...
        response = requests.post('https://api.mollie.com/v2/orders/ord_stTC2WHAuS/payments', headers=headers, data=data)
    ...
    def test_create_order_refund(self):
        ...
        data = '{ "lines": [ { "id": "odl_dgtxyl", "quantity": 1 } ], "description": "Required quantity not in stock, refunding one photo book.", "metadata": { "bookkeeping_id": 12345 } }'

        response = requests.post('https://api.mollie.com/v2/orders/ord_stTC2WHAuS/refunds', headers=headers, data=data)
...
class UnitTestsShipmentsAPI(unittest.TestCase):
    ...
    def test_create_shipment(self):
        ...
        data = {
            '{ "lines": [ { "id": "odl_dgtxyl", "quantity": 1 }, { "id": "odl_jp31jz" } ], "tracking": { "carrier": "PostNL", "code": "3SKABA000000000", "url": "http://postnl.nl/tracktrace/?B': '3SKABA000000000',
            'P': '1015CW',
            'D': 'NL',
            'T': 'C" } }'
        }

        response = requests.post('https://api.mollie.com/v2/orders/ord_kEn1PlbGa/shipments', headers=headers, data=data)
    ...
    def test_update_shipment(self):
        ...
        data = {
            '{ "tracking": { "carrier": "PostNL", "code": "3SKABA000000000", "url": "http://postnl.nl/tracktrace/?B': '3SKABA000000000',
            'P': '1015CW',
            'D': 'NL',
            'T': 'C" } }'
        }
...
class UnitTestsCustomersAPI(unittest.TestCase):
    ...
    def test_update_customer(self):
        ...
        response = requests.patch('https://api.mollie.com/v2/customers/cst_8wmqcHMN4U', headers=headers, data=data)
...
class UnitTestsSubscriptionsAPI(unittest.TestCase):
    ...
    def test_create_subscription(self):
        ...
        response = requests.post('https://api.mollie.com/v2/customers/cst_stTC2WHAuS/subscriptions', headers=headers,
                                 data=data)
    ...
    def test_get_subscription(self):
        ...
        response = requests.get('https://api.mollie.com/v2/customers/cst_stTC2WHAuS/subscriptions/sub_rVKGtNd6s3',
                                headers=headers)
    ...
    def test_cancel_subscription(self):
        ...
        response = requests.delete('https://api.mollie.com/v2/customers/cst_stTC2WHAuS/subscriptions/sub_rVKGtNd6s3',
                                   headers=headers)
    ...
    def test_list_subscriptions(self):
        ...
        response = requests.get('https://api.mollie.com/v2/customers/cst_8wmqcHMN4U/subscriptions', headers=headers)
    ...
    def test_list_subscription_payments(self):
        ...
        response = requests.get(
            'https://api.mollie.com/v2/customers/cst_8wmqcHMN4U/subscriptions/sub_8JfGzs6v3K/payments', headers=headers)
    ...
    def test_update_subscription(self):
        ...
        response = requests.patch('https://api.mollie.com/v2/customers/cst_5a2pPrwaWy/subscriptions/sub_8EjeBVgtEn',
                                  headers=headers, data=data)
...
class UnitTestsConnectAPI(unittest.TestCase):
    ...
    def test_revoke_token(self):
        ...
        data = {
            ...
            'token': 'refresh_FS4xc3Mgci2xQ5s5DzaLXh3HhaTZOP'
        }
...
class UnitTestsPermissionsAPI(unittest.TestCase):
    ...
    def test_get_permission(self):
        ...
        headers = {
            'Authorization': 'Bearer access_Wwvu7egPcJLLJ9Kb7J632x8wJ2zMeJ',
        }
...
class UnitTestsProfilesAPI(unittest.TestCase):
    ...
    def test_update_profile(self):
        ...
        response = requests.patch('https://api.mollie.com/v2/profiles/pfl_v9hTwCvYqw', headers=headers, data=data)
    ...
    def test_enable_payment_method(self):
        ...
        response = requests.post('https://api.mollie.com/v2/profiles/pfl_v9hTwCvYqw/methods/ideal', headers=headers)
    ...
    def test_disable_payment_method(self):
        ...
        response = requests.delete('https://api.mollie.com/v2/profiles/pfl_v9hTwCvYqw/methods/ideal', headers=headers)
    ...
    def test_enable_voucher_issuer(self):
        ...
        response = requests.post('https://api.mollie.com/v2/profiles/pfl_v9hTwCvYqw/methods/voucher/issuers/appetiz',
                                 headers=headers, data=data)
    ...
    def test_disable_voucher_issuer(self):
        ...
        response = requests.delete('https://api.mollie.com/v2/profiles/pfl_v9hTwCvYqw/methods/voucher/issuers/appetiz',
                                   headers=headers)
...
class UnitTestsOnboardingAPI(unittest.TestCase):
    ...
    def test_submit_onboarding_data(self):
        ...
        data = '{ "organization": { "name": "Mollie B.V.", "address": { "streetAndNumber": "Keizersgracht 126", "postalCode": "1015 CW", "city": "Amsterdam", "country": "NL" }, "registrationNumber": "30204462", "vatNumber": "NL815839091B01" }, "profile": { "name": "Mollie", "url": "https://www.mollie.com", "email": "info@mollie.com", "phone": "+31208202070", "categoryCode": 6012 } }'
