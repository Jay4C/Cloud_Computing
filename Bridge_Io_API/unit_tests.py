...
class Unit_Tests_Bridge_Io_API_Payments_Initiation(unittest.TestCase):
    def test_allow_payments_to_different_beneficiaries(self):
        ...
        data = '{ "successful_callback_url": "https://my-callback-url.com:8080/pay/success", "unsuccessful_callback_url": "https://my-callback-url.com:8080/pay/error", "transactions": [ { "end_to_end_id": "12345678-AFERS", "currency": "EUR", "label": "Payment label", "amount": 99.5, "client_reference": "12345678-AZERTY" } ], "user": { "name": "Firstname Lastname", "ip_address": "0.0.0.0", "external_reference": "AEF142536-890" }, "beneficiary": { "name": "Firstname Lastname", "iban": "FR76XXXXXXXXXXXXXXXX" }, "client_reference": "12345678-AZERTY", "bank_id": 6 }'
    ...
    def test_initiate_your_first_payment_to_a_default_beneficiary(self):
        ...
        data = '{ "successful_callback_url": "https://my-callback-url.com:8080/pay/success", "unsuccessful_callback_url": "https://my-callback-url.com:8080/pay/error", "transactions": [ { "end_to_end_id": "12345678-AFERS", "currency": "EUR", "label": "Payment label", "amount": 99.5, "client_reference": "12345678-AZERTY" } ], "user": { "name": "Firstname Lastname", "ip_address": "0.0.0.0", "external_reference": "AEF142536-890" }, "client_reference": "12345678-AZERTY", "bank_id": 6 }'
    ...
    def test_initiate_your_first_payment_to_different_beneficiaries(self):
        ...
        data = '{ "successful_callback_url": "https://my-callback-url.com:8080/pay/success", "unsuccessful_callback_url": "https://my-callback-url.com:8080/pay/error", "transactions": [ { "end_to_end_id": "12345678-AFERS", "currency": "EUR", "label": "Payment label", "amount": 99.5, "beneficiary": { "name": "Firstname Lastname", "iban": "0.0.0.0" }, "client_reference": "12345678-AZERTY" ], "user": { "name": "Firstname Lastname", "ip_address": "0.0.0.0", "external_reference": "AEF142536-890" }, "bank_id": 6 }'
...
class Unit_Tests_Bridge_Io_API_Financial_Data_Aggregation(unittest.TestCase):
    ...
    def test_first_synchronization(self):
        ...
        data = '${ "country": "fr", "prefill_email": "email@gmail.com", "iban": "FR7430003000502537446929K93", "capabilities": ["ais", "bulk_transfer"], "bank_id": 408 }'
