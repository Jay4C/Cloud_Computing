...
class UnitTestsShodanAPINetworkAlerts(unittest.TestCase):
    ...
    def test_shodan_alert_id_post(self):
        ...
        response = requests.post('https://api.shodan.io/shodan/alert/67UQ4JM3NGJKROR9', headers=headers, params=params,
                                 data=data)
    ...
    def test_shodan_alert_id_trigger_trigger_put(self):
        ...
        response = requests.put('https://api.shodan.io/shodan/alert/OYPRB8IR9Z35AZPR/trigger/new_service,vulnerable',
                                params=params)
    ...
    def test_shodan_alert_id_trigger_trigger_delete(self):
        ...
        response = requests.delete('https://api.shodan.io/shodan/alert/OYPRB8IR9Z35AZPR/trigger/new_service,vulnerable',
                                   params=params)
    ...
    def test_shodan_alert_id_trigger_trigger_ignore_service_put(self):
        ...
        response = requests.put(
            'https://api.shodan.io/shodan/alert/OYPRB8IR9Z35AZPR/trigger/new_service/ignore/1.1.1.1:53', params=params)
    ...
    def test_shodan_alert_id_notifier_notifier_id_put(self):
        ...
        response = requests.put('https://api.shodan.io/shodan/alert/OYPRB8IR9Z35AZPR/notifier/default', params=params)
