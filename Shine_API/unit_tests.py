...
class UnitTestsShineAPIAuthentication(unittest.TestCase):
    ...
    def test_get_authorize(self):
        ...
        querystring = {"client_id": "client_id", "scope": "scope", "redirect_uri": "redirect_uri", "state": "state",
...
class UnitTestsShineAPITransactions(unittest.TestCase):
    ...
    def test_get_query_4(self):
        ...
        querystring = {"bankAccountId": "bankAccountId", "first": "1", "last": "1", "after": "after",
                       "before": "before", "status": "VALIDATED", "paymentMethod": "CARD", "feeType": "FREE",
                       "category": "DEFAULT", "q": "q", "type": "payin", "hasReceipts": "true", "isPersonal": "true",
                       "isRefund": "true", "isHidden": "true", "transactionAfter": "1", "transactionBefore": "1",
...
class UnitTestsShineAPIBankTransfers(unittest.TestCase):
    ...
    def test_get_query_3(self):
        ...
        querystring = {"uid": "uid", "first": "1", "after": "after",
                       ...
                       "bankProviderTransferId": "bankProviderTransferId", "bankAccountId": "bankAccountId", "min": "1",
                       "max": "1", "status": "status"}
    ...
    def test_get_queryrecipient(self):
        ...
        querystring = {"uid": "uid", "name": "name", "first": "1", "after": "1", "bankProvider": "TREEZOR",
                       "bankProviderTransferRecipientId": "bankProviderTransferRecipientId", "usableForSct": "true",
                       "sepaCreditorIdentifier": "sepaCreditorIdentifier", "isTreezorBeneficiary": "true",
                       "includeDeleted": "true"}
...
class UnitTestsShineAPIInvoicesService(unittest.TestCase):
    ...
    def test_get_query(self):
        ...
        querystring = {"uid": "uid", "first": "1", "last": "1", "after": "1", "before": "1", "clientId": "clientId",
                       "fiscalId": "fiscalId", "deleted": "true", "searchInput": "searchInput", "status": "PAID"}
